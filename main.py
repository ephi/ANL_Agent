...
def ANL_Build_Docker_Settings(docker_path="C:/Users/yairk/Documents/השכלה ולימודים/תואר שני/בינה מלאכותית מתקדם/ANL2021/Docker_runner", negotiation_deadline=3):
...
def ANL_Analyzer(anl_res_path='C:/Users/yairk/Documents/השכלה ולימודים/תואר שני/בינה מלאכותית מתקדם/ANL2021/Docker_runner/results', show_all=True): 
    aul = {}
    ...
    for f_p in neg_files:
        ...
        if show_all:
            for key, val in ul.items():
                plt.plot(np.array(val), label=key)
